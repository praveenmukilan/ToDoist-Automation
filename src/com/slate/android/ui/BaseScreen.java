...
/**
 * BaseScreen pageobject from which other pageobjects inherit from. This class
 * holds the functionalities that are common to all the pageobjects.
 * 
 * @author praveenms
 **/
public class BaseScreen {
	...
	public void swipeUp() {
		...
		action.press(PointOption.point(width, startY)).waitAction().moveTo(PointOption.point(width, endY)).release()
				.perform();
	...
	public void waitForElement(String text) {
		...
		wait.until(ExpectedConditions
				.visibilityOf(driver.findElementByXPath("//android.widget.TextView[@text=\"" + text + "\"]")));
	}
